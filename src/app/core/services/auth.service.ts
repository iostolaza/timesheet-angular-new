...
// import { generateClient } from 'aws-amplify/data';
// import type { Schema } from '../../../../amplify/data/resource';
// import { Observable, from, BehaviorSubject, throwError, of, catchError, firstValueFrom, timeout } from 'rxjs';
...
//       console.log('User already exists:', user.id);
//     } catch (err) {
//       const model = this.client.models.User;
...
//   // Stub methods to avoid TS2339 errors
//   async listUsers(): Promise<User[]> {
//     return [];
//   }

//   async createGroup(_groupName: string): Promise<void> {
//     // Stub: Implement in FinancialService
//   }

//   async addUserToGroup(_email: string, _groupName: string): Promise<void> {
//     // Stub: Implement in FinancialService
//   }
// }